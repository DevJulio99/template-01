      ...
      <div className="team-notice flex justify-center">
            <div className="w-full px-[12px] md:max-w-[696px] lg:max-w-[936px]">
               <p className="text-center">
                ...
                <strong className="mr-[5px] text-[18px] md:text-[19px]">SEOStudio</strong>
                <span className="font-light text-[18px] md:text-[19px]">is your choice in the world of online marketing. </span>
                <strong className="text-[18px] md:text-[19px]">Contact us now!</strong>
               </p>
            </div>
      </div>
    </>
